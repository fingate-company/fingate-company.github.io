<template>
  <section class="ax-contact" aria-labelledby="ax-contact-heading">
    <div class="ax-contact__image" aria-hidden="true"></div>
    <div class="ax-contact__shade" aria-hidden="true"></div>
